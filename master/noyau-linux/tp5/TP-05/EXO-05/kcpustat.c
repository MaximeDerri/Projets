...
static unsigned int interval = 10; /* interval between reports in seconds */
static unsigned int frequency = HZ; /* samples frequency */
...
{
	struct my_kcpustat *k, *kk, *first, *prev;
	 ...
	 */
	list_for_each_entry_safe(k, kk, &my_head, list) {
		for (i = 0; i < NR_STATS; i++)
